...
def load(name):
    if name == "resnet18":
        ...
        model.load_state_dict(torch.load("C:/Users/Administrator/.cache/torch/hub/checkpoints/resnet18-f37072fd.pth"))
        return model
    elif name == "resnet101":
        model = models.resnet101(pretrained=False)
        model.load_state_dict(torch.load("C:/Users/Administrator/.cache/torch/hub/checkpoints/resnet101-63fe2227.pth"))
        return model
    elif name == "resnet50":
        model = models.resnet50(pretrained=False)
        model.load_state_dict(torch.load("C:/Users/Administrator/.cache/torch/hub/checkpoints/resnet50-0676ba61.pth"))
        return model
